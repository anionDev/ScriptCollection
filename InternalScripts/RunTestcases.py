...
def RunTestcases():
    ...
    coveragefile=os.path.join(repository_folder,"Other/TestCoverage.xml")
    GeneralUtilities.ensure_file_does_not_exist(coveragefile)
    os.rename(os.path.join(repository_folder,"coverage.xml"),coveragefile)
    GeneralUtilities.ensure_directory_does_not_exist(os.path.join(repository_folder,"Other/TestCoverage"))
    ...
    sc.start_program_synchronously("reportgenerator","-reports:Other/TestCoverage.xml -targetdir:Other/TestCoverage",repository_folder)
    sc.start_program_synchronously("reportgenerator","-reports:Other/TestCoverage.xml -targetdir:Other/Badges -reporttypes:Badges",repository_folder)
