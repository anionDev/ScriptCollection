...
parser = argparse.ArgumentParser(description='Changes the hash-value of arbitrary files by appending a whitespace at the end of the file.')

parser.add_argument('inputFile', type=str, help='Specifies the script/executable-file whose hash-value should be changed')

parser.add_argument('--valueToAppend', type=str, default=" ", help = 'Specifies the string should should be appended to the file')
