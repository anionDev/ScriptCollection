...
class TFCPS_MergeToMain:
    ...
    def merge_to_main_branch(self ) -> None:
        ...
        GeneralUtilities.assert_condition(self.sc.git_get_commit_id(source_branch)!=self.sc.git_get_commit_id(target_branch),"Source- and target-branch must not be the same commit.")
