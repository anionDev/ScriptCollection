...
from .TFCPS_DoRelease2_MainToStable import CreateReleaseConfigurationOld,TFCPS_DoRelease2_MainToStableOld
...
class TFCPS_DoRelease3_FullOld:
    ...
    def generic_create_release(self, generic_create_release_arguments: GenericCreateReleaseArgumentsOld) -> tuple[bool, str]:
        ...
        if merge_source_branch_commit_id == main_branch_commit_id:
            ...
            # create release
            m2:TFCPS_DoRelease2_MainToStableOld=TFCPS_DoRelease2_MainToStableOld()
