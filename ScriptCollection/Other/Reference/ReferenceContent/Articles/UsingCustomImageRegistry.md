...
```csv
ImageName;Image;UpstreamImage
debian;myownregistry1.example.com/debian;docker.io/library/debian
nginx;myownregistry1.example.com/nginx;docker.io/library/nginx
dotnet;myownregistry2.example.com/dotnetbase;mcr.microsoft.com/dotnet/aspnet
```
...
Settings credentials for basic auth on a registry is supported and can be used optionally.
On your development-machine and in your build-server-environment you have to create the file `~/.scriptcollection/GlobalCache/RegistryCredentials.csv`.
In this file you can specify the credentials for each registry.
