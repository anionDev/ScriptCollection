...
class GenericProgramRunner(ProgramRunnerBase):
    ...
    def run_program_argsasarray(self, arguments_as_array: list[str], working_directory: str, throw_exception_if_exitcode_is_not_zero: bool) -> list[int, str, str, int]:
