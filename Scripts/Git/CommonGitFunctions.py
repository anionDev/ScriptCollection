...
def commit(directory:str, message:str):
    ...
    if not (exitcode==0):
        print("Warning: 'git commit' results in exitcode "+str(exitcode)+". This means that probably either there were no changes to commit or an error occurred while commiting")
